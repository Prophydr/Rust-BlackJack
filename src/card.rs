...
{
    pub(crate) suit: Suits,
    pub(crate) number: u8,
    pub(crate) name: String,
    pub(crate) unicode: char
}

impl Card {
    pub(crate) fn new(suit: Suits, value: u8) -> Self {
        Self {
            suit,
    ...
    pub(crate) fn get_name_from_value(value: u8) -> String
    {
        match value {
            1 => "Ace".to_string(),
    ...
    pub(crate) fn get_value(value: u8) -> u8
    {
        match value {
            1..=10 => value,
            11..=13 => 10,
    ...
    pub(crate) fn get_unicode(suit: Suits, value: u8) -> char
    {
    ...
    pub(crate) fn convert_to_char(mid_value: &str, value: u8) -> char
    {
        let head = "0x1F0";
        ...
        let hex_str = u32::from_str_radix(&format!("{}{}{}", head, mid_value, end)[2..], 16).expect("Can't convert to hex");
